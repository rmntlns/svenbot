...
os.environ["LANGCHAIN_PROJECT"]="svenbot"

st.set_page_config(page_title="Sven Bot: Chat with PDF", page_icon="🧙‍♂️")
st.title("🧙‍♂️ Sven Bot")
...
if len(msgs.messages) == 0 or st.sidebar.button("Clear message history"):
    msgs.clear()
    msgs.add_ai_message("Hoe kan ik je helpen?")
